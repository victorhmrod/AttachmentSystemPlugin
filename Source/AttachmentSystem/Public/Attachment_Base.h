...
DECLARE_DELEGATE_OneParam(FOnMaterialChanged, const bool /* bActivate */)
    ...
    UCLASS() class ATTACHMENTSYSTEM_API AAttachment_Base : public AActor {
  GENERATED_BODY()
...
public:
  ...
  UPROPERTY(EditAnywhere, Category = "Parameters",
            meta = (ToolTip = "Radius before snapping take effect"))
  float Radius;

  UPROPERTY(EditAnywhere, Category = "Parameters",
            meta = (Tooltip = "Length/2 of the base to avoid standing in air"))
  float BaseOffset;
