...
void AAttachmentSystemCharacter::SetupPlayerInputComponent(
  ...
  if (UEnhancedInputComponent *EnhancedInputComponent =
    ...
    EnhancedInputComponent->BindAction(
        ...
        &AAttachmentSystemCharacter::DoJumpStart);
    EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed,
                                       this,
                                       &AAttachmentSystemCharacter::DoJumpEnd);

    // Moving
    EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered,
                                       this,
                                       &AAttachmentSystemCharacter::MoveInput);

    // Looking/Aiming
    EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered,
                                       this,
                                       &AAttachmentSystemCharacter::LookInput);
    EnhancedInputComponent->BindAction(MouseLookAction,
                                       ETriggerEvent::Triggered, this,
                                       &AAttachmentSystemCharacter::LookInput);
  } else {
    UE_LOG(
        LogAttachmentSystem, Error,
