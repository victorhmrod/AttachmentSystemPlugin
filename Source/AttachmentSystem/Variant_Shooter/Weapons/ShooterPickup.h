 ...
 */
UCLASS(abstract)
class ATTACHMENTSYSTEM_API AShooterPickup : public AActor {
  GENERATED_BODY()
...
protected:
  ...
  UPROPERTY(EditAnywhere, Category = "Pickup",
            meta = (ClampMin = 0, ClampMax = 120, Units = "s"))
...
protected:
  ...
  /** Passes control to Blueprint to animate the pickup respawn. Should end by
   * calling FinishRespawn */
  UFUNCTION(BlueprintImplementableEvent, Category = "Pickup",
            meta = (DisplayName = "OnRespawn"))
  void BP_OnRespawn();
