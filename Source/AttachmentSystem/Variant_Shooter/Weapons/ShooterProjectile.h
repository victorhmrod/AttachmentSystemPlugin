 ...
 */
UCLASS(abstract)
class ATTACHMENTSYSTEM_API AShooterProjectile : public AActor {
  GENERATED_BODY()
...
protected:
  ...
  /** Type of damage to apply. Can be used to represent specific types of damage
  ...
  /** If true, the projectile will explode and apply radial damage to all actors
   * in range */
  ...
  UPROPERTY(EditAnywhere, Category = "Projectile|Explosion",
            meta = (ClampMin = 0, ClampMax = 5000, Units = "cm"))
...
protected:
  ...
  UFUNCTION(BlueprintImplementableEvent, Category = "Projectile",
            meta = (DisplayName = "On Projectile Hit"))
