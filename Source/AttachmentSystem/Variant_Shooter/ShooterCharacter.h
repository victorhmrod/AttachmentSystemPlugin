...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FBulletCountUpdatedDelegate, int32,
                                             MagazineSize, int32, Bullets);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FDamagedDelegate, float,
                                            LifePercent);
 ...
 */
UCLASS(abstract)
class ATTACHMENTSYSTEM_API AShooterCharacter
    : public AAttachmentSystemCharacter,
...
protected:
  ...
  UPROPERTY(EditAnywhere, Category = "Aim",
            meta = (ClampMin = 0, ClampMax = 100000, Units = "cm"))
...
protected:
  ...
  AShooterWeapon *
  FindWeaponOfType(TSubclassOf<AShooterWeapon> WeaponClass) const;
  ...
  /** Called from the respawn timer to destroy this character and force the PC
   * to respawn */
  void OnRespawn();
};
