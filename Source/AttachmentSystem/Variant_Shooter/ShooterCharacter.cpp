...
AShooterCharacter::AShooterCharacter() {
  ...
  PawnNoiseEmitter = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(
      TEXT("Pawn Noise Emitter"));
...
void AShooterCharacter::SetupPlayerInputComponent(
  ...
  if (UEnhancedInputComponent *EnhancedInputComponent =
    ...
    EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Completed,
                                       this, &AShooterCharacter::DoStopFiring);

    // Switch weapon
    EnhancedInputComponent->BindAction(SwitchWeaponAction,
...
void AShooterCharacter::AttachWeaponMeshes(AShooterWeapon *Weapon) {
  ...
  Weapon->GetThirdPersonMesh()->AttachToComponent(GetMesh(), AttachmentRule,
...
void AShooterCharacter::OnWeaponActivated(AShooterWeapon *Weapon) {
  ...
  OnBulletCountUpdated.Broadcast(Weapon->GetMagazineSize(),
                                 Weapon->GetBulletCount());

  // set the character mesh AnimInstances
  GetFirstPersonMesh()->SetAnimInstanceClass(
      Weapon->GetFirstPersonAnimInstanceClass());
...
void AShooterCharacter::Die() {
  ...
  GetWorld()->GetTimerManager().SetTimer(
      RespawnTimer, this, &AShooterCharacter::OnRespawn, RespawnTime, false);
}
