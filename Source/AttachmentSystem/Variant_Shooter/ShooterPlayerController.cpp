	...
	if (IsLocalPlayerController())
	{
		if (SVirtualJoystick::ShouldDisplayTouchInterface())
		{
			...
			if (MobileControlsWidget)
			{
				...
				UE_LOG(LogAttachmentSystem, Error, TEXT("Could not spawn mobile controls widget."));
		...
		if (BulletCounterUI)
		{
			...
			UE_LOG(LogAttachmentSystem, Error, TEXT("Could not spawn bullet counter widget."));
